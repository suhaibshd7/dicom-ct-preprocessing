...
| Resampling | Resample anisotropic voxels (0.7×0.7×2.5mm) to 1mm isotropic |
...
The `.mhd` files saved in Section 12 are in the exact same format as LUNA16 subset files.
